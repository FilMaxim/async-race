...
class CarsListOne {
    ...
    protected createListCar() {
        const car = createHTMLElement('div', ['car']);
        car.id = '1';
        const carToolBar = createHTMLElement('div', ['car-toolbar']);
        const carChangeBtns = createHTMLElement('div', ['car-change-btns']);
        const btnChange = createHTMLElement('button', ['btn', 'btn-ch']);
    ...
    render() {
        this.container.append(this.createListCar());
        return this.container;
    }
}

export default CarsListOne;
